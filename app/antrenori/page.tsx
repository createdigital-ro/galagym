...
const Echipa = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-4xl md:text-6xl font-bold text-center text-[#0f0f0f] mt-4">
        Echipa noastra
      </h1>
      <h2 className="text-center text-[#0f0f0f] max-w-[400px] mx-auto md:max-w-[800px] md:text-2xl mt-2 mb-8">
        Antrenori personali care vă indrumă cu zâmbetul pe buze în călătoria
        către forma fizică ideala.
      </h2>
      <div className={`grid grid-cols-1 ${echipa.length >= 3 ? "xl:grid-cols-3" : ""} md:grid-cols-2 w-fit mx-auto md:justify-center items-center md:gap-10 gap-8 mt-12`}>
        {echipa.map((member) => (
          <Link href="/preturi">
            <div className="border-2 border-[#0f0f0f] shadow-lg hover:scale-105 active:scale-105">
              ...
              />
              <div className="leading-none px-2 py-2">
                <div className="flex">
