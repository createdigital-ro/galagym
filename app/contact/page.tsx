...
const Contact = () => {
  ...
  return (
    <div>
      ...
      />
      <h1 className="font-bold text-3xl ml-4 my-8 text-center sm:text-5xl lg:text-6xl">
        Contactează-ne
      </h1>
      <div className="flex flex-col lg:flex-row lg:justify-center lg:gap-12 items-center lg:mt-16">
        <div className="bg-[#0f0f0f] shadow-[6px_6px] lg:my-auto shadow-yellow-400 self-center text-white w-[290px] sm:w-[310px] xl:py-4 mb-8 py-2">
          ...
          <div className="flex flex-col gap-6">
            {socials.map((s) => (
              <div className="flex text-[#0f0f0f] bg-white w-[200px] mx-auto py-2 rounded-full gap-2 hover:shadow-[2px_2px] hover:shadow-yellow-400 hover:scale-105 active:scale-105 active:shadow-[2px_2px] active:shadow-yellow-400">
